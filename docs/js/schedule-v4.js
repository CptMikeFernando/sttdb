...
const LSU_MENS_BASKETBALL_2025_26 = [
  { date: '2025-11-05', opponent: 'UL Monroe', time: '8:00 PM', result: 'W 96-58' },
  { date: '2025-11-08', opponent: 'at UCF', time: '2:00 PM', result: 'W 75-68' },
  { date: '2025-11-14', opponent: 'Charleston So', time: '8:00 PM', result: 'W 90-37' },
  { date: '2025-11-17', opponent: 'vs Florida St', time: '6:30 PM', result: 'W 77-66' },
  { date: '2025-11-18', opponent: 'vs Wichita St', time: '8:30 PM', result: 'L 65-76' },
  { date: '2025-11-22', opponent: 'North Texas', time: '8:00 PM', result: 'W 78-53' },
  { date: '2025-11-26', opponent: 'vs Maryland', time: '9:30 PM', result: 'W 74-70' },
  { date: '2025-11-27', opponent: 'vs St. Johns', time: '9:30 PM', result: 'L 73-78' },
  { date: '2025-12-04', opponent: 'Tulane', time: '8:00 PM', result: 'W 90-63' },
  { date: '2025-12-07', opponent: 'SMU', time: '1:00 PM', result: 'W 81-65' },
  { date: '2025-12-14', opponent: 'Southern Miss', time: '4:00 PM', result: 'W 90-62' },
  { date: '2025-12-21', opponent: 'Pittsburgh', time: '5:00 PM', result: 'W 92-80' },
  { date: '2025-12-30', opponent: 'Nicholls', time: '6:00 PM', result: 'W 99-52' },
  { date: '2026-01-04', opponent: 'at Texas A&M', time: '1:00 PM', result: 'L 72-75' },
  { date: '2026-01-07', opponent: 'South Carolina', time: '9:00 PM', result: 'L 68-78' },
...
const LSU_WOMENS_BASKETBALL_2025_26 = [
  { date: '2025-11-04', opponent: 'Houston Christian', time: '8:00 PM', result: 'W 110-46' },
  { date: '2025-11-10', opponent: 'Florida St', time: '1:00 PM', result: 'W 94-68' },
  { date: '2025-11-14', opponent: 'East Texas A&M', time: '7:00 PM', result: 'W 109-46' },
  { date: '2025-11-17', opponent: 'Murray State', time: '3:00 PM', result: 'W 116-60' },
  { date: '2025-11-24', opponent: 'vs Oregon', time: '2:00 PM', result: 'W 89-53' },
  { date: '2025-11-25', opponent: 'vs San Diego St', time: '12:30 PM', result: 'W 97-51' },
  { date: '2025-12-01', opponent: 'at UCF', time: '5:00 PM', result: 'W 87-59' },
  { date: '2025-12-05', opponent: 'Grambling State', time: '7:00 PM', result: 'W 104-34' },
  { date: '2025-12-08', opponent: 'Lamar', time: '1:00 PM', result: 'W 103-43' },
  { date: '2025-12-15', opponent: 'at UCLA', time: '3:00 PM', result: 'L 68-71' },
  { date: '2025-12-18', opponent: 'UL Monroe', time: '7:00 PM', result: 'W 98-40' },
  { date: '2025-12-21', opponent: 'Louisiana Tech', time: '2:00 PM', result: 'W 88-49' },
  { date: '2025-12-29', opponent: 'Coppin State', time: '3:00 PM', result: 'W 114-40' },
  { date: '2026-01-02', opponent: 'at Tennessee', time: '8:00 PM', result: 'L 64-83' },
  { date: '2026-01-05', opponent: 'Georgia', time: '1:00 PM', result: 'W 80-59' },
  { date: '2026-01-09', opponent: 'at South Carolina', time: '6:00 PM', result: 'W 74-71' },
  { date: '2026-01-12', opponent: 'Texas', time: '3:00 PM' },
  { date: '2026-01-16', opponent: 'at Oklahoma', time: '8:00 PM' },
  { date: '2026-01-19', opponent: 'Alabama', time: '3:00 PM' },
  { date: '2026-01-23', opponent: 'at Texas A&M', time: '8:00 PM' },
  { date: '2026-01-30', opponent: 'Arkansas', time: '8:00 PM' },
  { date: '2026-02-02', opponent: 'Ole Miss', time: '3:00 PM' },
  { date: '2026-02-06', opponent: 'at Auburn', time: '6:00 PM' },
  { date: '2026-02-09', opponent: 'at Mississippi State', time: '3:00 PM' },
  { date: '2026-02-13', opponent: 'Kentucky', time: '8:00 PM' },
  { date: '2026-02-20', opponent: 'South Carolina', time: '8:00 PM' },
  { date: '2026-02-23', opponent: 'at Florida', time: '3:00 PM' }
];
