...
const LSU_MENS_BASKETBALL_2025_26 = [
  { date: '2025-11-05', opponent: 'Tarleton State', time: '7:00 PM', result: 'W 96-60' },
  { date: '2025-11-10', opponent: 'New Orleans', time: '7:00 PM', result: 'W 93-58' },
  { date: '2025-11-13', opponent: 'Florida Intl', time: '8:00 PM', result: 'W 98-81' },
  { date: '2025-11-18', opponent: 'Alcorn State', time: '7:00 PM', result: 'W 107-81' },
  { date: '2025-11-21', opponent: 'Omaha', time: '7:00 PM', result: 'W 99-73' },
  { date: '2025-11-28', opponent: 'vs Drake', time: 'TBD', result: 'W 71-62' },
  { date: '2025-11-29', opponent: 'vs DePaul', time: 'TBD', result: 'W 96-63' },
  { date: '2025-12-03', opponent: 'at Boston College', time: '7:00 PM', result: 'W 78-69 OT' },
  { date: '2025-12-07', opponent: 'vs Texas Tech', time: 'TBD', result: 'L 58-82' },
  { date: '2025-12-13', opponent: 'vs SMU', time: 'TBD', result: 'W 89-77' },
  { date: '2025-12-19', opponent: 'SE Louisiana', time: '7:00 PM', result: 'W 78-65' },
  { date: '2025-12-22', opponent: 'Prairie View', time: '2:00 PM', result: 'W 104-90' },
  { date: '2025-12-29', opponent: 'Southern Miss', time: '2:00 PM', result: 'W 90-62' },
  { date: '2026-01-03', opponent: 'at Texas A&M', time: 'TBD', result: 'L 72-75' },
  { date: '2026-01-06', opponent: 'South Carolina', time: '9:00 PM', result: 'L 68-78' },
  { date: '2026-01-10', opponent: 'at Vanderbilt', time: 'TBD', result: 'L 73-84' },
  { date: '2026-01-14', opponent: 'Kentucky', time: '7:00 PM' },
  { date: '2026-01-17', opponent: 'Missouri', time: '3:30 PM' },
  { date: '2026-01-20', opponent: 'at Florida', time: '7:00 PM' },
  { date: '2026-01-24', opponent: 'at Arkansas', time: '8:30 PM' },
  { date: '2026-01-28', opponent: 'Mississippi State', time: '7:00 PM' },
  { date: '2026-01-31', opponent: 'at South Carolina', time: '6:00 PM' },
  { date: '2026-02-07', opponent: 'Georgia', time: '6:00 PM' },
  { date: '2026-02-10', opponent: 'Arkansas', time: '9:00 PM' },
  { date: '2026-02-14', opponent: 'at Tennessee', time: '6:00 PM' },
  { date: '2026-02-17', opponent: 'at Texas', time: '9:00 PM' },
  { date: '2026-02-22', opponent: 'Ole Miss', time: 'TBD' },
  { date: '2026-02-25', opponent: 'at Alabama', time: 'TBD' },
  { date: '2026-03-01', opponent: 'Tennessee', time: 'TBD' },
  { date: '2026-03-04', opponent: 'Oklahoma', time: 'TBD' },
  { date: '2026-03-07', opponent: 'at Auburn', time: 'TBD' }
];

const LSU_WOMENS_BASKETBALL_2025_26 = [
  { date: '2025-11-04', opponent: 'Houston Christian', time: '8:00 PM', result: 'W 108-55' },
  { date: '2025-11-06', opponent: 'SE Louisiana', time: '7:00 PM', result: 'W 115-26' },
  { date: '2025-11-09', opponent: 'at Georgia Southern', time: '2:00 PM', result: 'W 118-70' },
  { date: '2025-11-12', opponent: 'Charlotte', time: '7:00 PM', result: 'W 117-59' },
  { date: '2025-11-17', opponent: 'at Tulane', time: '2:00 PM', result: 'W 101-71' },
  { date: '2025-11-20', opponent: 'Alcorn State', time: '7:00 PM', result: 'W 112-49' },
  { date: '2025-11-28', opponent: 'vs Marist', time: 'TBD', result: 'W 113-53' },
  { date: '2025-11-29', opponent: 'vs Washington St', time: 'TBD', result: 'W 112-35' },
  { date: '2025-12-04', opponent: 'at Duke', time: '7:00 PM', result: 'W 93-77' },
  { date: '2025-12-07', opponent: 'at New Orleans', time: '2:00 PM', result: 'W 126-62' },
  { date: '2025-12-13', opponent: 'Louisiana Tech', time: 'TBD', result: 'W 87-61' },
  { date: '2025-12-16', opponent: 'Morgan State', time: '7:00 PM', result: 'W 91-33' },
  { date: '2025-12-21', opponent: 'UT Arlington', time: '2:00 PM', result: 'W 110-45' },
  { date: '2025-12-28', opponent: 'Alabama State', time: '2:00 PM', result: 'W 109-41' },
  { date: '2026-01-01', opponent: 'Kentucky', time: 'TBD', result: 'L 78-80' },
  { date: '2026-01-04', opponent: 'at Vanderbilt', time: 'TBD', result: 'L 61-65' },
  { date: '2026-01-08', opponent: 'at Georgia', time: 'TBD', result: 'W 80-59' },
  { date: '2026-01-11', opponent: 'Texas', time: '3:00 PM', result: 'W 70-65' },
  { date: '2026-01-18', opponent: 'at Oklahoma', time: '3:00 PM' },
  { date: '2026-01-22', opponent: 'at Texas A&M', time: '9:00 PM' },
  { date: '2026-01-26', opponent: 'Florida', time: '8:00 PM' },
  { date: '2026-01-29', opponent: 'Arkansas', time: '8:00 PM' },
  { date: '2026-02-01', opponent: 'Alabama', time: '12:00 PM' },
  { date: '2026-02-05', opponent: 'at Texas', time: '9:00 PM' },
  { date: '2026-02-08', opponent: 'at Auburn', time: '2:00 PM' },
  { date: '2026-02-14', opponent: 'South Carolina', time: '8:30 PM' },
  { date: '2026-02-19', opponent: 'at Ole Miss', time: 'TBD' },
  { date: '2026-02-22', opponent: 'Missouri', time: 'TBD' },
  { date: '2026-02-26', opponent: 'at Tennessee', time: 'TBD' }
];
